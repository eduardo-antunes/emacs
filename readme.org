...
No momento, a minha fonte de preferência é a Iosevka. No Fedora, a minha distribuição Linux principal, é possível instalá-la com os seguintes comandos.
...
O próximo bloco de elisp se certifica de que a fonte seja carregada, independemente do modo de inicialização do emacs.
